...
function Airotabletwo() {
  const tableData = [
    {
      id: 1,
      code: "1701/A",
      product: "Airo 6A. 1 Way Switch",
      rate: "30.00",
      pkg: "20",
    },
    {
      ...
      >
        <div className="md:w-[80%] w-[95%]">
          <div className="flex items-center justify-center py-[30px] text-[20px] px-[20px]">
            <h6 className="text-center">AIRO SWITCH</h6>
          </div>
