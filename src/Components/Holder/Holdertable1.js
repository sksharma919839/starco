...
function Holdertable1() {
  const tableData = [
    {
      id: 1,
      code: "01",
      product: "KICK PLATE ANGLE HOLDER ALUMINUM BRASS PLATED RING",
      rate: "76.00",
      pkg: "10",
    },
    {
      id: 2,
      code: "02",
      product: "KICK PLATE BATTEN HOLDER ALUMINUM BRASS PLATED RING",
      rate: "76.00",
      pkg: "10",
    },
  ];
      ...
      >
        <div className="md:w-[80%] w-[95%] over-table">
          <div className="flex items-center justify-center py-[30px] text-[20px] px-[20px]">
            <h6 className="text-center">KICK PLATE ANGLE/BATTEN HOLDER</h6>
          </div>
