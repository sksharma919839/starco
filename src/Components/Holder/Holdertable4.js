...
function Holdertable4() {
  const tableData = [
    {
      id: 1,
      code: "07",
      product: "HEAVY DUTY ANGLE HOLDER ALUMINUM BRASS PLATED RING",
      rate: "38.00",
      pkg: "20",
    },
    {
      id: 2,
      code: "08",
      product: "HEAVY DUTY BATTEN HOLDER ALUMINUM BRASS PLATED RING",
      rate: "38.00",
      pkg: "20",
    },
  ];
      ...
      >
        <div className="md:w-[80%] w-[95%] over-table">
          <div className="flex items-center justify-center py-[30px] text-[20px] px-[20px]">
            <h6 className="text-center">HEAVY DUTY ANGLE/BATTEN HOLDER</h6>
          </div>
