...
function Holdertable5() {
  const tableData = [
    {
      id: 1,
      code: "09",
      product: "KICK DOME ANGLE HOLDER ALUMINUM BRASS PLATED RING",
      rate: "52.00",
      pkg: "20",
    },
    {
      id: 2,
      code: "10",
      product: "KICK DOME BATTEN HOLDER ALUMINUM BRASS PLATED RING",
      rate: "52.00",
      pkg: "20",
    },
  ];
      ...
      >
        <div className="md:w-[80%] w-[95%] over-table">
          <div className="flex items-center justify-center py-[30px] text-[20px] px-[20px]">
            <h6 className="text-center">KICK DOME ANGLE/BATTEN HOLDER</h6>
          </div>
