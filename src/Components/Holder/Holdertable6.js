...
function Holdertable6() {
  const tableData = [
    {
      id: 1,
      code: "011",
      product: "MINI PLATE ANGLE HOLDER ALUMINUM BRASS PLATED RING",
      rate: "62.00",
      pkg: "10",
    },
    {
      id: 2,
      code: "012",
      product: "MINI PLATE BATTEN HOLDER ALUMINUM BRASS PLATED RING",
      rate: "62.00",
      pkg: "10",
    },
  ];
      ...
      >
        <div className="md:w-[80%] w-[95%] over-table">
          <div className="flex items-center justify-center py-[30px] text-[20px] px-[20px]">
            <h6 className="text-center">MINI PLATE ANGLE / BATTEN HOLDER</h6>
          </div>
