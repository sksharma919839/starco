...
function Holdertable7() {
  const tableData = [
    {
      id: 1,
      code: "013",
      product: "TIGER PLATE ANGLE HOLDER ALUMINUM BRASS PLATED RING",
      rate: "72.00",
      pkg: "10",
    },
    {
      id: 2,
      code: "014",
      product: "TIGER PLATE BATTEN HOLDER ALUMINUM BRASS PLATED RING",
      rate: "72.00",
      pkg: "10",
    },
    {
      id: 3,
      code: "014/A",
      product: "KICK ROUND PLATE BATTEN HOLDER ALUMINUM BRASS PLATED RING",
      rate: "88.00",
      pkg: "10",
    },
  ];
        ...
        <div className="md:w-[80%] w-[95%] over-table">
          <div className="flex items-center justify-center py-[30px] text-[20px] px-[20px]">
            <h6 className="text-center">
              TIGER PLATE ANGLE / BATTEN HOLDER / KICK ROUND PLATE BATTEN HOLDER
            </h6>
          </div>
